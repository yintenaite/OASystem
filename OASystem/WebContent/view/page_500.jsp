						...
						<div class="col-lg-12 col-md-12 col-xs-12">
							<div class="text-center">
								...
								<a href="javascript: history.go(-1)">
									<button type="button" class="btn btn-danger"><i class="fa fa-chevron-left"></i> 返回</button>
								</a>
								<a href="view/login.jsp">
									<button type="button" class="btn btn-danger"><i class="fa fa-lock"></i> 登陆</button>
								</a>
								<a href="view/login.jsp">
									<button type="button" class="btn btn-danger"><i class="fa fa-envelope"></i> 联系我们</button>
								</a>
							</div>						
						</div>					
					</div>			
